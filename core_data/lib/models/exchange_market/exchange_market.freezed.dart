...
ExchangeMarket _$ExchangeMarketFromJson(Map<String, dynamic> json) {
  return _ExchangeMarket.fromJson(json);
}

/// @nodoc
mixin _$ExchangeMarket {
  ...
  @JsonKey(ignore: true)
  $ExchangeMarketCopyWith<ExchangeMarket> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ExchangeMarketCopyWith<$Res> {
  factory $ExchangeMarketCopyWith(
          ExchangeMarket value, $Res Function(ExchangeMarket) then) =
      _$ExchangeMarketCopyWithImpl<$Res, ExchangeMarket>;
  @useResult
  $Res call(
      {String exchangeId,
      String baseId,
...
/// @nodoc
class _$ExchangeMarketCopyWithImpl<$Res, $Val extends ExchangeMarket>
    implements $ExchangeMarketCopyWith<$Res> {
  _$ExchangeMarketCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_ExchangeMarketCopyWith<$Res>
    implements $ExchangeMarketCopyWith<$Res> {
  factory _$$_ExchangeMarketCopyWith(
          _$_ExchangeMarket value, $Res Function(_$_ExchangeMarket) then) =
      __$$_ExchangeMarketCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String exchangeId,
...
/// @nodoc
class __$$_ExchangeMarketCopyWithImpl<$Res>
    extends _$ExchangeMarketCopyWithImpl<$Res, _$_ExchangeMarket>
    implements _$$_ExchangeMarketCopyWith<$Res> {
  __$$_ExchangeMarketCopyWithImpl(
      _$_ExchangeMarket _value, $Res Function(_$_ExchangeMarket) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_ExchangeMarket(
      exchangeId: null == exchangeId
          ? _value.exchangeId
          : exchangeId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_ExchangeMarket implements _ExchangeMarket {
  _$_ExchangeMarket(
  ...
  factory _$_ExchangeMarket.fromJson(Map<String, dynamic> json) =>
      _$$_ExchangeMarketFromJson(json);
  ...
  @override
  String toString() {
    return 'ExchangeMarket(exchangeId: $exchangeId, baseId: $baseId, quoteId: $quoteId, baseSymbol: $baseSymbol, quoteSymbol: $quoteSymbol, volumeUsd24Hr: $volumeUsd24Hr, priceUsd: $priceUsd, volumePercent: $volumePercent)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, exchangeId, baseId, quoteId,
      baseSymbol, quoteSymbol, volumeUsd24Hr, priceUsd, volumePercent);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_ExchangeMarketCopyWith<_$_ExchangeMarket> get copyWith =>
      __$$_ExchangeMarketCopyWithImpl<_$_ExchangeMarket>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ExchangeMarketToJson(
      this,
    );
  }
}

abstract class _ExchangeMarket implements ExchangeMarket {
  factory _ExchangeMarket(
      ...
      required final String volumePercent}) = _$_ExchangeMarket;

  factory _ExchangeMarket.fromJson(Map<String, dynamic> json) =
      _$_ExchangeMarket.fromJson;
